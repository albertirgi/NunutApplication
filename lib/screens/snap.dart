...
//     try {
//       var title, desc;
//       Midtrans midtrans = Midtrans(MIDTRANS_PAYMENT_TYPE.bank_transfer,
...
//       } else {
//         Result result = await MidtransApi.handleTopup(
//             data['order_id'], data['payment_type'], data['status']);
//         if (result.status != 200) {
//           Fluttertoast.showToast(
//               msg: 'Something went wrong while handling response: ' +
//                   result.message);
//           Navigator.pushNamedAndRemoveUntil(context, '/main', (route) => false);
//           return;
//         } else {
